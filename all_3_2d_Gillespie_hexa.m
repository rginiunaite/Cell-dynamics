% combination of Gillespie on a hexagonal lattice, logistic and Runge-Kutta with KSA in 2D
...
TimeReductionFactor = 1; % when death rate is increased, this has to be increased as well
...
save('gillespie2D_large_initial_Pp05_Pd01_hexa.mat','save_time','save_density','save_cA0','save_store_time');

S = load('gillespie2D_large_initial_Pp05_Pd01.mat');
...
hold on
plot(rescaled_time,y_log,'LineWidth', 3)
xlabel('rescaled time','FontSize',14)
ylabel('rescaled density','FontSize',14)
