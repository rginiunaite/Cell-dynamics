% combination of Gillespie (40 realisations) from saved data, logistic and Runge-Kutta with KSA in 1D
...
S = load('gillespie1D_Pp1_Pd0.mat'); % load the data for a particular choice of Pp and Pd, note that L=100 is fixed
