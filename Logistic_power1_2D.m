% combination logistic and Runge-Kutta with power 1 approximation in 2D
...
h_legend = legend('Gillespie 2D','Logistic growth','Power 1');
set(h_legend,'FontSize',14)
xlabel('rescaled time','FontSize',14)
ylabel('rescaled density','FontSize',14)
...
function deriv = dynamics(t,y,Pm,Pp,Pd,max_rad,dr)
    ...
    deriv(2) = (Pm*0.5* (y(4) + 2 * y(3) - 3* y(2)) - 2 * Pd*y(2) + ...
        Pp * 0.5 * ((y(4)+y(3))*(1-y(1)) + 6*(y(1)-y(2))*y(1) -6*(y(1)^2*(1-y(1))))); % distance 1
    
    deriv(3) = 0.5 * Pm * (y(2) + y(5) + y(2) + y(5) - 4*y(3)) - ...
        2 * Pd * y(3) + 0.5 * Pp * ((y(2) + y(5) + y(2) + y(5))*(1-y(1)) + 4*(y(1)-y(3))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); % distance srt(2)
    
    deriv(4) = 0.5 * Pm * (y(7) + y(2) + y(5) + y(5) - 4*y(4)) - ...
        2 * Pd * y(4) + 0.5 * Pp * ((y(7)+y(2)+y(5)+y(5))*(1-y(1)) + 4*(y(1)-y(4))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); % distance 2
    
    deriv(5) = 0.5 * Pm * (y(8) + y(3) + y(6) + y(4) - 4*y(5)) - ...
        2 * Pd * y(5) + 0.5 * Pp * ((y(8) + y(3) + y(6) + y(4))*(1-y(1)) + 4*(y(1)-y(5))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); % distance sqrt(5)
    
    deriv(6) = 0.5 * Pm * (y(9) + y(5) + y(9) + y(5) - 4*y(6)) - ...
        2 * Pd * y(6) + 0.5 * Pp * ((y(9) + y(5) + y(9) + y(5))*(1-y(1)) + 4*(y(1)-y(6))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); % distance sqrt(8)
    
    deriv(7) = 0.5 * Pm * (y(10) + y(4) + y(8) + y(8) - 4*y(7)) - ...
        2 * Pd * y(7) + 0.5 * Pp * ((y(10) + y(4) + y(8) + y(8))*(1-y(1)) + 4*(y(1)-y(7))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); % distance 3     
    
    deriv(8) = 0.5 * Pm * (y(11) + y(9) + y(5) + y(7) - 4*y(8)) - ...
        2 * Pd * y(8) + 0.5 * Pp * ((y(11) + y(9) + y(5) + y(7))*(1-y(1)) + 4*(y(1)-y(8))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1))));
    
    deriv(9) = 0.5 * Pm * (y(12) + y(8) + y(6) + y(13) - 4*y(9)) - ...
        2 * Pd * y(9) + 0.5 * Pp * ((y(12) + y(8) + y(6) + y(13))*(1-y(1)) + 4*(y(1)-y(9))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1))));  
    
    deriv(10) = 0.5 * Pm * (y(7) + y(14) + y(11) + y(11) - 4*y(10)) - ...
        2 * Pd * y(10) + 0.5 * Pp * ((y(7) + y(14) + y(11) + y(11))*(1-y(1)) + 4*(y(1)-y(10))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); 
    
    deriv(11) = 0.5 * Pm * (y(13) + y(10) + y(8) + y(15) - 4*y(11)) - ...
        2 * Pd * y(11) + 0.5 * Pp * ((y(13) + y(10) + y(8) + y(15))*(1-y(1)) + 4*(y(1)-y(11))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); 
        
    deriv(12) = 0.5 * Pm * (y(9) + y(9) + y(14) + y(14) - 4*y(12)) - ...
        2 * Pd * y(12) + 0.5 * Pp * ((y(9) + y(9) + y(14) + y(14))*(1-y(1)) + 4*(y(1)-y(12))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1)))); 
    
    deriv(13) = 0.5 * Pm * (y(11) + y(14) + y(9) + y(15) - 4*y(13)) - ...
        2 * Pd * y(13) + 0.5 * Pp *  ((y(11) + y(14) + y(9) + y(15))*(1-y(1)) + 4*(y(1)-y(13))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1))));  % distance sqrt(20)
    
    
    %%%% If dr =0.5 fixed, I will not vary it, then
    
    deriv(14) = 0.5 * Pm * (y(13) + y(12) + y(16) + y(16) - 4*y(14)) - ...
        2 * Pd * y(14) + 0.5 * Pp * ((y(13) + y(12) + y(16) + y(16))*(1-y(1)) + 4*(y(1)-y(14))*y(1) +4*y(1)*(y(1)-y(2)) -8*(y(1)^2*(1-y(1))));% distance 5
...
%     end       
    ...
    while current_radius +dr < max_rad -dr % this is very approximate
        ...
        deriv(i) = Pm * (y(i-1)+ y(i+1) - 2 *y(i))/dr^2 + 1/current_radius * (y(i+1) - y(i-1))/(2*dr) ...
            - 2 * Pd * y(i) + Pp *((y(i+1)+ y(i-1))*(1-y(1)) + 2*(y(1)-y(i))*y(1) +2*y(1)*(y(1)-y(2)) -4*(y(1)^2*(1-y(1))));
    ...
    deriv(last) =  Pm * (y(last-1)+ y(2) - 2 *y(last))/dr^2 + 1/current_radius * (y(2) - y(last-1))/(2*dr) ...
            - 2 * Pd * y(last) + Pp *((y(1)+ y(last-1))*(1-y(1)) + 2*(y(1)-y(last))*y(1) +2*y(1)*(y(1)-y(2)) -4*(y(1)^2*(1-y(1))));
