% HEXAGONAL DOMAIN: combination logistic and Runge-Kutta with KSA + maximum entropy closure in 2D
...
S = load('gillespie2D_Pp1_Pd05_40G_hexa.mat'); % load the data for a particular choice of Pp and Pd, note that L=100 is fixed
