...
rescaled_time = (Pp-Pd)*store_time;
...
hold on
plot(store_time,y_log_new,'LineWidth', 3)
xlabel('time','FontSize',14)
ylabel('density','FontSize',14)
...
N = round(store_time(length(1:round(length(store_time))))/dt); % number of simulations, chosen to be the same as for Gillespie
